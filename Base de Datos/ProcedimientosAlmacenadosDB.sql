...
begin  --verificacion de clave primaria
	...
	begin
		...
		begin
			insert into TDevolucion values (@IdDevolucion, @IdUsuario, @IdVenta, @Razon, @Fecha)
...
begin  --verificacion de clave primaria
	...
	begin
		...
		begin
			update TDevolucion
			set IdDevolucion = @IdDevolucion, IdUsuario = @IdUsuario, IdVenta = @IdVenta, Razon = @Razon, Fecha = @Fecha
